        ...
        <section className={"o-static"}>
          <Fade bottom cascade>
            ...
            <div className={"o-static__inner"}>
              ...
              <p>退社後、都内数社の制作プロダクション・スタートアップ企業に在籍し、アパレルブランド、大型SCサイト「小田急百貨店」などのブランドリニューアルに関わる。</p>
              <p>2016年にフリーランスへ。現在までメガベンチャー・スタートアップ企業にフリーランスとして参画中。</p>
            </div>
            <div className={"o-static__inner"}>
              <h2 className={"title"}>プロダクト開発におけるエンジニアとの協業経験が豊富</h2>
              <p>様々なウェブメディアやサービスサイトの開発に関わっており画面デザインをつくる事に関しては高水準のクオリティで対応可能。またエンジニアとの協業経験も豊富にあり、現代のプロダクト開発に必要とされるフロントエンドデザインと知識を提供することをお約束します。</p>
            </div>
            <div className={"o-static__inner"}>
              <h2 className={"title"}>デザインモックだけでなく実装も得意です</h2>
              ...
              <p>デザインとコーディングを分業して対応するケースもありますが、私の場合にそれは当てはまりません。実装こみで高水準のクオリティで納品可能です。</p>
            </div>
            <div className={"o-static__inner"}>
