          ...
          <Fade bottom cascade>
            ...
            <div className={"o-static__inner"}>
              ...
              <p>
                ...
                大手アパレル・美容ブランドのCMキャンペーンサイトのデザイン・モーション制作にアシスタントデザイナーとして関わる。
              </p>
              <p>
            ...
            <div className={"o-static__inner"}>
              ...
              <p>
                フルスタックではありませんが、様々なスキルセットに対する理解は持っているので、クライアントもしくはデザイナー・エンジニアといった開発メンバーの間の繋ぎの役回りに回ることも多いです。
              </p>
              <p>
